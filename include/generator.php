<div class="container <?php echo $_SESSION['mode'] == 'night' ? 'dark' : ''; ?>">
    <div class="row mt-3">
        <div class="col-md-12 bg-white pt-3 mb-3 <?php echo $_SESSION['mode'] == 'night' ? 'dark' : ''; ?>">
            ...
            <div class="row">
                ...
                if ($_CONFIG['uploader'] == true) { ?>
                    <div class="col-12 mb-2">
                        <form method="post" enctype="multipart/form-data" id="sottometti">
                            ...
                            <label class=" <?php echo $_SESSION['mode'] == 'night' ? 'dark' : ''; ?>"><?php echo getString('upload_or_select_watermark'); ?></label>
                        </form>
                    </div>
                    <?php
                }
                 ...
                 * Watermarks
                 */ ?>
                <form role="form" id="create" class="needs-validation" novalidate style="padding: 10px">
                    <div class="row">
                        <?php
                        /**
                         * QR CODE DATA
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <!--            <div class="col-12 pt-4 mb-2 px-0">-->
                            <!--                <div class="col-12 btn px-0">-->
                            <!---->
                            <!--                    <div class="dropdown px-0">-->
                            <!--                        <button class="btn btn-secondary  rounded col-12" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">-->
                            <!--                            Language - اللغة <span class="fa fa-chevron-down"></span>-->
                            <!--                        </button>-->
                        ...
                        <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-6 col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control colorpickerback <?php echo $_SESSION['mode'] == 'night' ? 'dark' : ''; ?>" data-format="hex"
                                    ...
                                    <div class="col-6 col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control colorpickerfront <?php echo $_SESSION['mode'] == 'night' ? 'dark' : ''; ?>" data-format="hex"
                            ...
                            <button type="button" class="btn btn-lg btn-block btn-primary ellipsis" id="submitcreate">
